...
#define STRING_MSG "Enter a name between 1 and 29 characters inclusive "
#define REGISTERED_MSG "Name has been registered. Please choose a different name "
#define ENTERED_BROADMSG " has entered the game! "
#define TURN_MSG  " has the next turn! "
